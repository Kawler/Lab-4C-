...
{
	double temp = -51;
	cout << "Enter your trapezoid: " << endl;
...
void Trapezoid::area()
{
	double s = (side[1]+side[2])/2 * sqrt(side[0]*side[0]-(((side[2]-side[1])* (side[2] - side[1]) + side[0]*side[0] - side[3]*side[3])/(2*(side[2]-side[1]))* (((side[2] - side[1]) * (side[2] - side[1]) + side[0] * side[0] - side[3] * side[3]) / (2 * (side[2] - side[1])))));
	cout << "Area = " << s << endl;
}


void Trapezoid::perimetr()
{
	cout << "Perimetr = " << side[0] + side[1] + side[2] + side[3] << endl;
}
